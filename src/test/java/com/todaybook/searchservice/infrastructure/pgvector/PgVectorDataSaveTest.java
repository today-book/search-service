    ...
    void save1() {
        List<Document> documents = List.of(
                ...
                new Document(
                        ...
                        Map.of(
                                "title", "미라클 모닝",
                                "categories", List.of("자기계발", "라이프스타일")
                        )
                ),
                new Document(
